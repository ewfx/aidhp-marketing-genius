...
class CreditCardSocialMediaInsightAgent(BaseAgent):
    """
    Specialized agent for generating social media insights about Credit cards
    """
    def __init__(self, 
                 name: str = "CreditCardSocialMediaInsightAgent",
                 collection_name: str = "CreditCardSocialData"):
        """
        Initialize the Credit Card Social Media Insight Agent
        ...
        self.ad_prompt_template = ChatPromptTemplate.from_messages([
            ...
            Provide the ad copy in a clear, direct format.""")
        ])
    ...
    def initialize(self):
        ...
        """
        self.log_action('info', 'Initializing Credit Card Social Media Insight Agent')
    ...
    def run(self, input_data: Any = None) -> Dict:
        ...
        try:
            ...
            self.firebase_service.store_insights(
                collection_name='SocialInsights',
                document_id='CreditCard',
                data=insights
            )
