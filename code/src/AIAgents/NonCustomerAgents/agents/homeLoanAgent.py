...
class HomeLoanSocialMediaInsightAgent(BaseAgent):
    """
    Specialized agent for generating social media insights about Home Loans
    """
    def __init__(self, 
                 name: str = "HomeLoanSocialMediaInsightAgent",
                 collection_name: str = "HomeLoanSocialData"):
        """
        Initialize the Home Loan Social Media Insight Agent
        ...
        self.prompt_template = ChatPromptTemplate.from_messages([
            ("system", """You are an expert social media trend analyst specializing in home loan usage and experience insights.
            
            Analyze the provided social media conversations with the following objectives:
            1. Identify emerging trends in home loan usage
            ...
            ("human", """Analyze the following social media conversations about home loan usage:
        ...
        self.ad_prompt_template = ChatPromptTemplate.from_messages([
            ...
            Provide the ad copy in a clear, direct format. Create only one ad""")
        ])
    ...
    def initialize(self):
        ...
        """
        self.log_action('info', 'Initializing Home Loan Social Media Insight Agent')
    ...
    def run(self, input_data: Any = None) -> Dict:
        ...
        try:
            ...
            image_prompt = self.llm_service.generate_response(
                ...
                input_data={'trend_summary': insights.get('trend_summary')}
            )
